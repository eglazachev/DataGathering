...
def superjob_updater(collection):
    ...
    for n in is_next:
        if n.text == 'Дальше':
            ...
            superjob_updater(collection)


def hh_updater(collection):
    ...
    if len(is_next) != 0 and hh_params['page'] != 3:
        ...
        sleep(2 + randint(200, 300) / 50)
        hh_updater(collection)
...
proxies = {
    'http': 'https://188.68.186.115:8080',
}
